...
foreach ($enderecos as $endereco) {
    ...
    $resultados .= '<tr>
                        ...
                        <td class="text-center">
                            <button onclick="buscaEditarEndereco('.$endereco->id_endereco.')" type="button"class="btn btn-sm me-1 btn-primary" data-coreui-toggle="tooltip" data-coreui-placement="top" title="Editar"><i style="color:black;" class="fa-regular fa-pen-to-square"></i></button>
