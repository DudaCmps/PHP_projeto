...
foreach ($alugueis as $aluguel) {
    ...
    $resultados .= '<tr>
                        ...
                        <td class="text-center">
                            ...
                            <a onclick="return confirm(\'Tem certeza que deseja deletar?\');" href="../alugueis/excluirAluguel.php?id_aluguel='.$aluguel->id_aluguel.'" ><button type="button" class="btn btn-sm btn-danger" data-coreui-toggle="tooltip" data-coreui-placement="top" title="Excluir"><i class="cil-trash"></i></button></a>
                        </td>
                    </tr>';
}
