...
<div class="sidebar sidebar-fixed border-end" id="sidebar">
    ...
    <ul class="sidebar-nav">
      ...
      <li class="nav-item">
          <a class="nav-link" href="<?= BASE_URL ?>reservas/criaReserva.php">
          <i class="cil-paperclip me-2"></i> Pagamentos
          </a>
      </li>
    ...
    <div class="container-fluid h-100 d-flex align-items-center px-4">
        ...
        <div class="dropdown">
            ...
            <div class="d-flex flex-column justify-content-center text-start">
                <span class="fw-semibold">Maria Campos</span>
            ...
            <li><a class="dropdown-item" href="clientes/editarPerfil.php">Editar Perfil</a></li>
