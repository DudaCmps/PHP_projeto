...
<div class="sidebar sidebar-fixed border-end" id="sidebar">
    ...
    <ul class="sidebar-nav">
      ...
      <li class="nav-title">Veículos e Reservas</li>

      <li class="nav-item">
          <a class="nav-link" href="<?= BASE_URL ?>clientes/reservasCliente.php">
          <i class="cil-paperclip me-2"></i> Minhas reservas
          </a>
      </li>

      <li class="nav-item">
          <a class="nav-link" href="<?= BASE_URL ?>clientes/listagemVeiculos.php">
          <i class="cil-paperclip me-2"></i> Reservar um Veículo
          </a>
      </li>

      <li class="nav-title">Alugueis</li>
      <li class="nav-item">
          <a class="nav-link" href="<?= BASE_URL ?>clientes/alugueisCliente.php">
  ...
  <header class="header header-sticky border-bottom" 
    ...
    <div class="container-fluid h-100 d-flex align-items-center px-4">
        ...
        <div class="dropdown">
            ...
            <li><a class="dropdown-item" href="../endereços/listagemEnderecos.php">Meus Endereços</a></li>
